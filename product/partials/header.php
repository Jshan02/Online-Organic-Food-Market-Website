...
<body>
  <nav class="navbar navbar-dark bg-dark fixed-top">
    ...
    <a class="navbar-brand" href="../product/home.php">
      <img src="../product/photo/logo.png" alt="Organic" width="125">
    </a>
    <form action="../product/search.php" method="POST" class="form-inline  my-lg-0 col-md-5 ml-5">
      <input class="form-control mr-sm-2 col-md-5 ml-5" type="search" name="search" placeholder="Interested in Anything?">
        ...
        <li class="nav-item">
          <div class="btn-group">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item" href="../address/address2.php">My Addresses</a>
              <a class="dropdown-item" href="../viewOrder/toShip.php">My Order</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item text-danger" href="../general/logOut.php">Log Out</a>
            </div>
          </div>
        </li>
        <li class="nav-item">
