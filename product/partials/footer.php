<footer id="footer" class="pt-4 md-5 pt-md-5 border-top bg-dark px-5 pb-3">
    <div class="row">
      <div class="col-6 col-md">
        <h5>Organic-X</h5>
        <ul class="list-unstyled text-small">
          <li><a class="text-muted" href="../aboutUs/aboutUs.php">Our Story</a></li>
          <li><a class="text-muted" href="../product/shipping.php">Shipping</a></li>
          <li><a class="text-muted" href="../product/returnandrefund.php">Return and Refund</a></li>
        </ul>
      </div>
      <div class="col-6 col-md">
        <h5>My Account</h5>
        <ul class="list-unstyled text-small">
          <li><a class="text-muted" href="../profile/profile.php">My Account</a></li>
          <li><a class="text-muted" href="../viewOrder/toShip.php">Order History</a></li>
        </ul>
      </div>
      <div class="col-6 col-md">
        <h5>Support</h5>
