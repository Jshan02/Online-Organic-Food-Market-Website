...
<body>
    ...
    if (isset($_GET['custID'])) {
        ...
        $sql4 = "SELECT * FROM cust_order  WHERE OrderStatus = 'To Ship' AND CustID = '$cust_id' " ;
...
<a class="btn btn-lg btn-success" href="../admin/toShip.php" role="button">&laquo; Back to Customers' Order Page </a>
</center>
