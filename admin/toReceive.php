...
<body>
    ...
    <section class="pt-5 mt-5 container">
        <h2 class="font-weight-bold pt-5">Customer's Order - To Receive</h2>
        <hr>
    </section>
        ...
        <table>
            ...
            <tbody>
                <?php 
                    ...
                    //// show all the 'To Receive' order records according to specific user's id ////
                    $sql4 = "SELECT * FROM cust_order WHERE OrderStatus = 'To Receive'" ;
                ...
                <tr>
                    ...
                    <td>
                    <a href="receiveDetails.php?orderID=<?php echo $order_id;?>&custID=<?php echo $cust_id;?>">View Details</a></button>
                    </td>
