...
<body>
    ...
    <section class="pt-5 mt-5 container">
        <h2 class="font-weight-bold pt-5">Customer's Order - To Ship</h2>
        <hr>
    </section>
        ...
        <table>
            ...
            <tbody>
                <?php                  
                    ...
                    $sql4 = "SELECT * FROM cust_order  WHERE OrderStatus = 'To Ship'" ;
                ...
                <tr>
                    ...
                    <td>
                    <a href="shipDetails.php?orderID=<?php echo $order_id;?>&custID=<?php echo $cust_id;?>">View Details</a></button>
                    </td>
                    <td> <?php echo $order_date;?> </td>
                    <td>RM<?php echo $total;?> </td>
                    <td> <?php echo $order_status;?> </td>
                    <td>
                    <a href="ship.php?shipID=<?php echo $order_id;?>"><button class="btn btn-success">Shipped</button></a>
                    </td>
                </tr>
                <?php }  ?>
            </tbody>
