...
<body>
    ...
    <section class="pt-5 mt-5 container">
        <h2 class="font-weight-bold pt-5">My Order - Completed</h2>
        <hr>
    </section>
        ...
        <table>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <td>
                    <a href="../rating/rating.php?ProID=<?php echo $pro_id; ?>"><button class="btn btn-primary">Rate</button></a> &nbsp;&nbsp;
                    <a href="../product/details.php?ProID=<?php echo $pro_id;?>"><button class="btn btn-success">Buy Again</button></a>
                    </td>
                </tr>
                <?php }}} ?>
            </tbody>
